...
<div class="px-64 py-8">
  <form id="storyForm" action="/story/store" method="post" class="flex justify-between my-8">
    @csrf
    <div class="basis-9/12 flex flex-col">
      <!-- title -->
      <input required class="outline-0 font-semibold text-4xl mb-8" autofocus type="text" placeholder="Judul" name="title" maxlength="100">
      <!-- <div id="editor-container" class="h-96 text-lg"></div> -->
      <!-- body -->
      <!-- <input type="hidden" id="editor-content" name="body"> -->
      <textarea name="body" id="editor-container" cols="30" class="text-lg">Your Story…</textarea>
    ...
    <div class="basis-2/12">
      ...
      <label for="tag" class="font-semibold">Add Story Tag</label>
      <!-- story_tag -->
      <select name="tag_id" id="tag" class="bg-sky-50 py-2 px-4 rounded-full text-sm mt-2">
        <option value="1">Your Story Tag</option>
